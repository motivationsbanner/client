...
Player::Player(int X, int Y, bool pmainplayer, std::string  pname)
{
	...
	name = pname;
	//todo font von dem server laden und über dem charakter anzeigen lassen
	txtname.setString(name);
	txtname.setPosition(X, Y);
